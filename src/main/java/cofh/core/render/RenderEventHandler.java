...
public class RenderEventHandler implements IResourceManagerReloadListener {
	...
	public void drawBlockDamageTexture(Tessellator tessellatorIn, BufferBuilder vertexBuffer, Entity entityIn, float partialTicks, World world, List<BlockPos> blocks) {
		...
		int progress = (int) (Minecraft.getMinecraft().playerController.hashCode() * 10.0F) - 1;
