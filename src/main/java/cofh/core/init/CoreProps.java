...
public class CoreProps {
	...
	private static final String BUILD = "2335";
	private static final String FORGE_REQ = "14.21.0." + BUILD;

	public static final String FORGE_DEP = "required-after:Forge@[" + FORGE_REQ + "];";
	...
	/* GLOBAL CONSTANTS */
	public static final GameProfile DEFAULT_OWNER = new GameProfile(UUID.fromString("b344687b-ec74-479a-9540-1aa8ccb13e92"), "[None]");
