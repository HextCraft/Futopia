...
public class CoreEnchantments {
	...
	public static void preInit() {
		...
		GameData.register_impl(holding);
		GameData.register_impl(multishot);
	}
	...
	/* TYPES */
	public static final EnumEnchantmentType ENCHANTMENT_TYPE_STORAGE = EnumHelper.addEnchantmentType("COFH:STORAGE", null);
