...
public class RecipeUpgradeOverride extends RecipeUpgrade {
	...
	public RecipeUpgradeOverride(ResourceLocation rl, ItemStack result, Object... recipe) {

		super(rl, result, recipe);
	}

	public RecipeUpgradeOverride(ResourceLocation rl, int slot, ItemStack result, Object... recipe) {

		super(rl, slot, result, recipe);
	}
