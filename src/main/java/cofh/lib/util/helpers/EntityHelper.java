...
public class EntityHelper {
	...
	/*public static void transferPlayerToDimension(EntityPlayerMP player, double x, double y, double z, int dimension, ServerCommandManager manager) {
