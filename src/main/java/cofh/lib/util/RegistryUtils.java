...
public class RegistryUtils {
	...
	private static class Repl {
		...
		private static Class<IRegistryDelegate<?>> DelegateClass;
		...
		private static void alterDelegate(Object obj, Object repl) {
			...
			if (obj instanceof Item) {
				IRegistryDelegate<Item> delegate = ((Item) obj).delegate;
		...
		static {
			...
			try {
				DelegateClass = (Class<IRegistryDelegate<?>>) Class.forName("net.minecraftforge.fml.common.registry.RegistryDelegate$Delegate");
			} catch (Throwable e) {
