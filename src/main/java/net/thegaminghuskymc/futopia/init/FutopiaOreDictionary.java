...
public class FutopiaOreDictionary {
    ...
    public static void init() {
        ...
        IntStream.range(0, 8).forEach(meta -> registerWithHandlers("blockFutopia" + StringUtils.capitalize(EnumMaterialType.values()[meta].getName()), new ItemStack(FTBlocks.storages, 1, meta)));
