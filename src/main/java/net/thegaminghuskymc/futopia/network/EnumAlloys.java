...
public enum EnumAlloys implements IStringSerializable {
	...
	TITANIUM("Titanium", 0, EnumOreType.BLOCK, EnumOreType.NUGGET, EnumOreType.INGOT, EnumOreType.DUST,
			EnumOreType.PLATE, EnumOreType.FLUID), BRONZE("Bronze", 1, EnumOreType.BLOCK, EnumOreType.NUGGET,
					EnumOreType.INGOT, EnumOreType.DUST, EnumOreType.PLATE, EnumOreType.FLUID), ELECTRUM("Electrum", 2,
							EnumOreType.BLOCK, EnumOreType.NUGGET, EnumOreType.INGOT, EnumOreType.DUST,
							EnumOreType.PLATE, EnumOreType.FLUID), STEEL("Steel", 3, EnumOreType.BLOCK,
