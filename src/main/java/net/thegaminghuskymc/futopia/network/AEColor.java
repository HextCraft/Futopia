...
public enum AEColor
{
	...
	WHITE( "gui.futopia.White", EnumDyeColor.WHITE, 0xBEBEBE, 0xDBDBDB, 0xFAFAFA ),

	ORANGE( "gui.futopia.Orange", EnumDyeColor.ORANGE, 0xF99739, 0xFAAE44, 0xF4DEC3 ),

	MAGENTA( "gui.futopia.Magenta", EnumDyeColor.MAGENTA, 0x821E82, 0xB82AB8, 0xC598C8 ),

	LIGHT_BLUE( "gui.futopia.LightBlue", EnumDyeColor.LIGHT_BLUE, 0x628DCB, 0x82ACE7, 0xD8F6FF ),

	YELLOW( "gui.futopia.Yellow", EnumDyeColor.YELLOW, 0xFFF7AA, 0xF8FF4A, 0xFFFFE8 ),

	LIME( "gui.futopia.Lime", EnumDyeColor.LIME, 0x7CFF4A, 0xBBFF51, 0xE7F7D7 ),

	PINK( "gui.futopia.Pink", EnumDyeColor.PINK, 0xDC8DB5, 0xF8B5D7, 0xF7DEEB ),

	GRAY( "gui.futopia.Gray", EnumDyeColor.GRAY, 0x7C7C7C, 0xA0A0A0, 0xC9C9C9 ),

	LIGHT_GRAY( "gui.futopia.LightGray", EnumDyeColor.SILVER, 0x9D9D9D, 0xCDCDCD, 0xEFEFEF ),

	CYAN( "gui.futopia.Cyan", EnumDyeColor.CYAN, 0x2F9BA5, 0x51AAC6, 0xAEDDF4 ),

	PURPLE( "gui.futopia.Purple", EnumDyeColor.PURPLE, 0x8230B2, 0xA453CE, 0xC7A3CC ),

	BLUE( "gui.futopia.Blue", EnumDyeColor.BLUE, 0x2D29A0, 0x514AFF, 0xDDE6FF ),

	BROWN( "gui.futopia.Brown", EnumDyeColor.BROWN, 0x724E35, 0xB7967F, 0xE0D2C8 ),

	GREEN( "gui.futopia.Green", EnumDyeColor.GREEN, 0x45A021, 0x60E32E, 0xE3F2E3 ),

	RED( "gui.futopia.Red", EnumDyeColor.RED, 0xA50029, 0xFF003C, 0xFFE6ED ),

	BLACK( "gui.futopia.Black", EnumDyeColor.BLACK, 0x2B2B2B, 0x565656, 0x848484 ),

	TRANSPARENT( "gui.futopia.Fluix", null, 0x1B2344, 0x895CA8, 0xD7BBEC );
