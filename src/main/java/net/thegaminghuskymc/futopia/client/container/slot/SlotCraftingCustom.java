...
import net.thegaminghuskymc.futopia.client.container.InventoryCraftingFutopia;

public class SlotCraftingCustom extends Slot
{
    /** The craft matrix inventory linked to this result slot. */
    private final InventoryCraftingFutopia craftMatrix;
    /** The player that is using the GUI where this slot resides. */
    private final EntityPlayer player;
    /** The number of items that have been crafted so far. Gets passed to ItemStack.onCrafting before being reset. */
    private int amountCrafted;

    public SlotCraftingCustom(EntityPlayer player, InventoryCraftingFutopia craftingInventory, IInventory inventoryIn, int slotIndex, int xPosition, int yPosition)
    {
