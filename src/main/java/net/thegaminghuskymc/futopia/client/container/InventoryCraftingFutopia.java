...
public class InventoryCraftingFutopia extends InventoryCrafting implements IInventory
{
    ...
    public InventoryCraftingFutopia(Container eventHandlerIn, int width, int height)
    {
    	super(eventHandlerIn, height, height);
