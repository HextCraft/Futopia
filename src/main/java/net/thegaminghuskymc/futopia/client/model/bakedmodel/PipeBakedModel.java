package net.thegaminghuskymc.futopia.client.model.bakedmodel;
...
public class PipeBakedModel implements IBakedModel {
    ...
    public static final ModelResourceLocation BAKED_MODEL = new ModelResourceLocation(Refs.MODID+ ":" + BlockNames.pipe);

    private TextureAtlasSprite sprite;
    private VertexFormat format;

    public PipeBakedModel(IModelState state, VertexFormat format,
    		Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
        this.format = format;
        sprite = bakedTextureGetter.apply(new ResourceLocation(Refs.MODID, "blocks/isbmtexture"));
    }
