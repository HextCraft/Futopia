...
public class GuiCrafter extends GuiContainer implements IRecipeShownListener {
	...
	public void initGui() {
		...
		// this.recipeBookGui.init(this.width, this.height, this.mc,
		// this.widthTooNarrow, this.inventorySlots,
		// ((ContainerCrafter)this.inventorySlots).craftMatrix);
		this.guiLeft = this.recipeBookGui.updateScreenPosition(this.widthTooNarrow, this.width, this.xSize);
		this.recipeButton = new GuiButtonImage(10, this.guiLeft + 5, this.height / 2 - 49, 20, 18, 0, 168, 19,
