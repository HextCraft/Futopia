...
public class GuiCrafter extends GuiContainer implements IRecipeShownListener{
    ...
    public void initGui()
    {
        ...
        this.recipeBookGui.init(this.width, this.height, this.mc, this.widthTooNarrow, this.inventorySlots, ((ContainerCrafter)this.inventorySlots).craftMatrix);
        this.guiLeft = this.recipeBookGui.updateScreenPosition(this.widthTooNarrow, this.width, this.xSize);
        this.recipeButton = new GuiButtonImage(10, this.guiLeft + 5, this.height / 2 - 49, 20, 18, 0, 168, 19, new ResourceLocation("textures/gui/container/crafting_table.png"));
    ...
    {
        this.fontRenderer.drawString(I18n.format("Project Table"), 28, 6, 4210752);
    ...
    protected void actionPerformed(GuiButton button) throws IOException
    {
        if (button.id == 10)
        {
            this.recipeBookGui.initVisuals(this.widthTooNarrow, ((ContainerCrafter)this.inventorySlots).craftMatrix);
