...
import net.thegaminghuskymc.futopia.init.BlockLoader;
import net.thegaminghuskymc.futopia.init.FTCreativeTabs;
import net.thegaminghuskymc.futopia.utils.BlockNames;
import net.thegaminghuskymc.futopia.utils.test.UnlistedPropertyBlockAvailable;
...
public class BlockPipe extends Block {
    ...
    public BlockPipe() {
        super(Material.ROCK);
        setUnlocalizedName(BlockNames.pipe);
        setRegistryName(BlockNames.pipe);
