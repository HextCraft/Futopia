...
import net.thegaminghuskymc.futopia.blocks.BaseThingyBlock
import net.thegaminghuskymc.futopia.client.ThingiesTexture
import net.thegaminghuskymc.futopia.network.UnlistedFluidProperty
    ...
    private fun getFluidStackInfo(state: IBlockState?, stack: ItemStack?, index: Int): FluidStackInfo? {
        ...
        if (extended != null) {
            ...
            if ((fluid != null) && (fluid.fluid != null) && (fluid.amount > 0)) {
                return FluidStackInfo(fluid.fluid, Math.round(fluid.amount.toFloat() / 93.75f).toInt())
            }
        }
