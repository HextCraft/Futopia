...
public class ItemMaterial extends ItemMulti implements IInitializer {
	...
	public boolean postInit() {
		...
		/* Smelting */
		/*
		 * addSmelting(ingotRed, dustRed, 0.0F); addSmelting(ingotBlue,
		 * dustBlue, 0.0F); addSmelting(ingotPurple, dustPurple, 0.0F);
		 * addSmelting(ingotGreen, dustGreen, 0.0F); addSmelting(ingotZinc,
		 * dustZinc, 0.0F); addSmelting(ingotTungsten, dustTungsten, 0.0F);
		 * addSmelting(ingotBrass, dustBrass, 0.0F); addSmelting(ingotTesselite,
		 * dustTesselite, 0.0F);
		 * 
		 * addTwoWayStorageRecipe(ingotRed, "ingotRed", nuggetRed, "nuggetRed");
		 * addTwoWayStorageRecipe(ingotBlue, "ingotBlue", nuggetBlue,
		 * "nuggetBlue"); addTwoWayStorageRecipe(ingotPurple, "ingotPurple",
		 * nuggetPurple, "nuggetPurple"); addTwoWayStorageRecipe(ingotGreen,
		 * "ingotGreen", nuggetGreen, "nuggetGreen");
		 * addTwoWayStorageRecipe(ingotZinc, "ingotZinc", nuggetZinc,
		 * "nuggetZinc"); addTwoWayStorageRecipe(ingotTungsten, "ingotTungsten",
		 * nuggetTungsten, "nuggetTungsten"); addTwoWayStorageRecipe(ingotBrass,
		 * "ingotBrass", nuggetBrass, "nuggetBrass");
		 * addTwoWayStorageRecipe(ingotTesselite, "ingotTesselite",
		 * nuggetTesselite, "nuggetTesselite");
		 * 
		 ...
		 * 
		 * addGearRecipe(dustRed, "ingotRed"); addGearRecipe(dustBlue,
		 * "ingotBlue"); addGearRecipe(dustPurple, "ingotPurple");
		 * addGearRecipe(dustGreen, "ingotGreen"); addGearRecipe(dustZinc,
		 * "ingotZinc"); addGearRecipe(dustTungsten, "ingotTungsten");
		 * addGearRecipe(dustBrass, "ingotBrass"); addGearRecipe(dustTesselite,
		 * "ingotTesselite");
		 */
